...
def MultiDay(dfp, dfspot, u, z, h, b0, bmax, bmin, xmax, c_tilde):
    ...
    for i in range(len(dfp)):
        ...
        for j in range(dfp['Atime_diff'][i]):
            ...
            costs += x0*c[0];               # Cost of charging in the now-hour
...
plot_EMPC(prob, 'Multi-Day Smart Charge', starttime=starttime, endtime=endtime, export=True)
